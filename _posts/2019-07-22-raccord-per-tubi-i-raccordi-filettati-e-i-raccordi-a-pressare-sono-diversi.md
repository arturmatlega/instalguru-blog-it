...
- question: Raccordi PEX - come installarli?
  answer: Il metodo di installazione dei raccordi per tubi PEX dipende dalla loro
    costruzione. Prima di iniziare il processo di installazione è necessario assicurarsi
    di quale tipo si possiede e seguire le istruzioni del produttore.
- question: Come misurare i raccordi per tubi?
  answer: La misurazione dei tubi e dei raccordi dipende dal tipo di filettatura.
    Per le filettature maschio, misurare il diametro esterno. Per i filetti femmina
    si dovrebbe misurare il diametro interno.
- question: Come sudare i raccordi in rame?
  answer: Iniziare dalla pulizia del metallo e dall'applicazione di una pasta disossidante.
    Mettere il raccordo sul tubo e riscaldare il giunto in modo che la pasta disossidante
    si sciolga e fissi il raccordo.
- question: Come rimuovere i raccordi in pex?
  answer: Il modo più semplice per rimuovere i raccordi per tubi PEX è l'utilizzo
    di uno speciale strumento di rimozione. Usatelo per tagliare la fascetta ad anello
    a crimpare. Molti tipi, ad esempio i raccordi in rame possono essere riutilizzati,
    se non sono danneggiati.
