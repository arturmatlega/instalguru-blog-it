...
faq:
- question: Come saldare i tubi di rame?
  answer: Se non siete professionisti, non cercate di saldare un tubo del gas. È meglio
    assumere uno specialista che lo faccia in modo rapido e sicuro.
- question: Come si collegano i tubi in PVC?
  answer: È possibile collegare un tubo in PVC incollandolo. Coprire le estremità
    di entrambi gli elementi con la colla e poi applicare la colla. Questo è un metodo
    molto semplice per collegare un tubo in pvc.
- question: Quanto durano i tubi di rame?
  answer: I tubi di rame durano in genere circa 20 anni. Se mantenuto correttamente,
    questo tipo di materiale per tubazioni può durare fino a 50 anni - in alcuni casi
    anche di più.
- question: Che cosa sono i tubi in pvc?
  answer: L'abbreviazione PVC sta per cloruro di polivinile. Negli ultimi tempi è
    comune sostituire i tubi metallici con tubi in PVC negli impianti idrici.
